...
<<<<<<< HEAD
  render() {
    ...
    const taxAmount =
      Math.round(
        (this.props.transaction.total / (this.state.tax + 1)) *
          this.state.tax *
          100
      ) / 100;
    return (
      <>
        <Container>
          ...
          />
          <p>
            <b>Transaction ID:</b> {this.props.transaction._id}
          </p>
          <p>
            <b>Date:</b> {dateTime[0]}
          </p>
          ...
          <table>
            ...
            <tbody>
              ...
              this.props.transaction.cartItems.length ? (
                Array.from(this.props.transaction.cartItems).map(
                  (transaction) => (
            ...
            <Container>
                ...
                <table>
                    ...
                    <tr style={{border:"none"}}>
                        ...
                        <td style={{paddingTop: "0px"}}>${Math.round((this.props.transaction.total + taxAmount) * 100) / 100}</td>
>>>>>>> marcus
                    </tr>
                  )
                )
              ...
              <tr style={{ border: "none" }}>
                ...
                <td style={{ textAlign: "right", paddingTop: "0px" }}>
                  <b>Tax ({Math.round(this.state.tax * 100 * 10) / 10}%)</b>:
                </td>
                <td style={{ paddingTop: "0px" }}>${taxAmount}</td>
              </tr>
              <tr style={{ border: "none" }}>
                ...
                <td style={{ paddingTop: "0px" }}>
                  $
                  {Math.round(
                    (this.props.transaction.total + taxAmount) * 100
                  ) / 100}
                </td>
              </tr>
            </tbody>
...
export default connect(mapStateToProps, { getProfile })(Transaction);
